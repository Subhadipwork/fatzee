...
function initFatzee() {
    ...
    function L() {
        if ($(".menu-items").length) {
            var a = $(".menu-items").isotope({
                singleMode: true,
                olumnWidth: ".grid-sizer, .grid-sizer-second, .grid-sizer-three",
                itemSelector: ".menu-item, .menu-item-second, .menu-item-three"
            });
            a.imagesLoaded(function () {
                a.isotope("layout");
            });
            $(".menu-filters").on("click", "a.menu-filter", function (b) {
                b.preventDefault();
                var c = $(this).attr("data-filter");
                a.isotope({
                    filter: c
                });
                $(".menu-filters a.menu-filter").removeClass("menu-filter-active");
                $(this).addClass("menu-filter-active");
                return false;
            });
        }
    }
        ...
        $("#map-canvas").gmap3({
            ...
            marker: {
                ...
                values: [{
                    ...
                    data: "Fatzee  - New York City",
                    options: {
                        icon: "images/marker.png"
                    }
                }, {
                    latLng: [40.7168183, -73.9973402],
                    data: "Fatzee - Washington",
                    options: {
                        icon: "images/marker.png"
                    }
                }, {
    ...
    const header = document.querySelector(".btmheader");
...
function openlogin() {
    document.getElementById('addSection1').classList.add('openlogin')
}
function closelogin() {
    document.getElementById('addSection1').classList.remove('openlogin')
}

// Register modal

function openRgeFrom() {
    document.getElementById('addSection2').classList.add('openrgefrom')
}
function closergeFeom() {
    document.getElementById('addSection2').classList.remove('openrgefrom')
}

// add to cart numbers in menu
...
function openOrder() {
    document.getElementById('menuOrder').classList.add('openorder')
}
function closeOrder() {
    document.getElementById('menuOrder').classList.remove('openorder')
}
